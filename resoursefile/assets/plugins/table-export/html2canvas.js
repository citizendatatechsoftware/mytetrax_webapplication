...
_html2canvas.Parse = function (images, options, cb) {
  ...
  function getCSSInt(element, attribute) {
    ...
    return (isNaN(val)) ? 0 : val; // borders in old IE are throwing 'medium' for demo.php
  }
...
window.php2canvas = function(elements, opts) {
...
window.php2canvas.log = _html2canvas.Util.log; // for renderers
window.php2canvas.Renderer = {
