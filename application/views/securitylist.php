                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonlist"> 
                                 <a class="btn btn-add" href="<?php base_url(); ?>addsecurity"> <i class="fa fa-plus"></i> Add Security
                                 </a>  
                              </div>
      ...
      <button type="submit" name="submit">Submit</button>
            ...
            if($fetch_data->num_rows() > 0){
               foreach ($fetch_data->result() as $row) {
                  ?>
                                    <tr>
                                       <td><img src="<?php echo base_url(); ?><?php echo "resoursefile/person_prof/".$row->image; ?>" class="img-circle" alt="User Image" width="50" height="50"> </td>
                                       <td><?php echo $row->clientid; ?></td>
                                       <td><?php echo $row->userid; ?></td>
                                       <td><?php echo $row->username; ?></td>
                                         
                                  <td><a href="mailto:<?php echo $row->email; ?>?Subject=Your Username Password Bellow&body=userid: <?php echo $row->userid; ?> password: <?php echo $row->password; ?>"  class="__cf_email__"><?php echo $row->email; ?></a></td>
                                      ...
                                      <?php
                                       ...
                                       <td>
                                         <a href="<?php echo base_url(); ?>edit/<?php echo $row->id; ?>"> <button type="button" class="btn btn-add btn-sm" data-target="#customer1"><i class="fa fa-pencil"></i></button></a>
                                          <a href="<?php echo base_url(); ?>delete/?id=<?php echo $row->id; ?>" onClick="return confirm('Are You Sure Want delete?');"> <button type="button" class="btn btn-danger btn-sm" data-target="#customer2" value="delete"><i class="fa fa-trash-o"></i> </button></a>
